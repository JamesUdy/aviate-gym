...
const HeroContent = () => {
  return (
    <section className='absolute bottom-2 sm:bottom-10 pr-4  sm:pr-0 sm:w-3/4 text-white pl-2 sm:pl-10 xl:pl-16 flex flex-col space-y-6 sm:space-y-10 xl:space-y-16'>
        ...
        <p className='text-[8px] sm:text-sm lg:text-md xl:text-lg tracking-tight'>Get fit fast with Aviate's certified personal trainers. Enjoy cardio, strength, and weight
training with top equipment. Join now and make 'Impossible...</p>
        </div>
